...
public abstract class GameEngine implements ActionListener, KeyListener, MouseListener, MouseMotionListener {
	//-------------------------------------------------------
	...
	JMenuItem speedItem,aboutItem,tankItem;
	...
	public void setupWindow(int width, int height) {
		...
		//Set up the icon of the windows
		ImageIcon icon =  new ImageIcon("tank.jpg");
		...
		// Add the menu bar items to the frame.
		...
		mFrame.add(controlMenu);
		menuBar.add(controlMenu);

		speedItem = new JMenuItem("Speed of Game");
		speedItem.addActionListener(this);
		tankItem = new JMenuItem("Num of Tank");
		tankItem.addActionListener(this);
		controlMenu.add(speedItem);
		controlMenu.add(tankItem);

		aboutItem = new JMenuItem("About");
		aboutItem.addActionListener(this);
		controlMenu.add(aboutItem);
